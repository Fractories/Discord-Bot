...
import de.fractories.discordbot.command.ClearCommand;
...
public class Util {
    ...
    public static void register(JDABuilder jdaBuilder) {
        ...
        jda.updateCommands().addCommands(
                Commands.slash("clear", "Clears a chat")
                        .addOption(OptionType.INTEGER, "anzahl", "die Anzahl an Nachrichten, welche gelöscht werden sollen."),
        ...
        register.addCommand("clear", new ClearCommand());
        ticket = new Ticket();
        ticket.createTable();
        botSettings = new BotSettings();
        botSettings.createTable();
        botSettings.get("roles").thenAccept(roles -> ticketRoles.addAll(Arrays.asList(roles.split(","))));
